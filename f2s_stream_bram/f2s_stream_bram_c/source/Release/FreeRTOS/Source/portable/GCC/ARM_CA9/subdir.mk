...
FreeRTOS/Source/portable/GCC/ARM_CA9/%.o: ../FreeRTOS/Source/portable/GCC/ARM_CA9/%.S FreeRTOS/Source/portable/GCC/ARM_CA9/subdir.mk
	...
	arm-none-eabi-gcc -mcpu=cortex-a9 -marm -mfloat-abi=hard -mfpu=neon -mno-unaligned-access -O2 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -g -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
